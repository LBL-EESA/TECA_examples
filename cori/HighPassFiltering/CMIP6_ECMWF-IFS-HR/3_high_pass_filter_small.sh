...
#SBATCH -t 12:00:00
#SBATCH -A nstaff
#SBATCH -J 3_high_pass_filter_px
...
echo "===================================== 10y WITHOUT cb  WITHOUT partition_x ${ag} stripes ${n} nodes"

# make a directory for the output files
out_dir=HighResMIP_ECMWF_ECMWF-IFS-HR_highresSST-present_r1i1p1f1_6hrPlevPt/ivt_all_hpf_small_${n}
...
time srun -N ${NN} -n ${n} \
    python3 -m mpi4py `which teca_spectral_filter` \
        ...
        --collective_buffer 0 --file_layout yearly --verbose 1

echo "===================================== 10y WITHOUT cb partition_x ${ag} stripes ${n} nodes "

# make a directory for the output files
out_dir=HighResMIP_ECMWF_ECMWF-IFS-HR_highresSST-present_r1i1p1f1_6hrPlevPt/ivt_all_hpf_small_px${n}
